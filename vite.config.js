...
export default defineConfig({
  base: '/Joule-Calc/', // <-- AGGIUNGI QUESTA RIGA (sostituisci con il nome del tuo repo)
  plugins: [
    VitePWA({
      manifest,
      registerType: 'autoUpdate',
      includeAssets: ['favicon.ico', 'apple-touch-icon.png', 'logo-96x96.png', 'screenshots/*.png', 'sounds/*.mp3'],
      pwaAssets: {
        disabled: true,
      },
